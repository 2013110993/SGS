...
"border:0;"));
    ...
    {
        Dashboard->setWindowTitle(QApplication::translate("Dashboard", "UB Student Platform | Dashboard", Q_NULLPTR));
        mainMenu_groupBox->setTitle(QApplication::translate("Dashboard", "Main Menu", Q_NULLPTR));
        dashboard_pushButton->setText(QApplication::translate("Dashboard", "Dashboard", Q_NULLPTR));
        AddProgramSequence_pushButton->setText(QApplication::translate("Dashboard", "Program Sequence", Q_NULLPTR));
        accounts_groupBox->setTitle(QApplication::translate("Dashboard", "Accounts", Q_NULLPTR));
        dashboard_pushButton_2->setText(QApplication::translate("Dashboard", "Student Account", Q_NULLPTR));
        AddProgramSequence_pushButton_2->setText(QApplication::translate("Dashboard", "Lecturer Account", Q_NULLPTR));
        settings_groupBox->setTitle(QApplication::translate("Dashboard", "Settings", Q_NULLPTR));
        resetPasswd_pushButton->setText(QApplication::translate("Dashboard", "Reset Password", Q_NULLPTR));
        addProgamSeqSettings_pushButton->setText(QApplication::translate("Dashboard", "Program Sequence", Q_NULLPTR));
        suspendAccount_pushButton->setText(QApplication::translate("Dashboard", "Suspend User", Q_NULLPTR));
        logout_pushButton->setText(QApplication::translate("Dashboard", "Logout", Q_NULLPTR));
        userLabel->setText(QApplication::translate("Dashboard", "Admin", Q_NULLPTR));
        welcomeLabel->setText(QApplication::translate("Dashboard", "Welcome:", Q_NULLPTR));
    } // retranslateUi
