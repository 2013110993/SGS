...
""));
    ...
    {
        dashboardStudent->setWindowTitle(QApplication::translate("dashboardStudent", "Form", Q_NULLPTR));
        mainMenu_groupBox->setTitle(QApplication::translate("dashboardStudent", "Main Menu", Q_NULLPTR));
        accounts_groupBox->setTitle(QApplication::translate("dashboardStudent", "My Account", Q_NULLPTR));
        mainMenu_groupBox_2->setTitle(QApplication::translate("dashboardStudent", "Settings", Q_NULLPTR));
        pushButton_5->setText(QApplication::translate("dashboardStudent", "View Profile", Q_NULLPTR));
        pushButton_6->setText(QApplication::translate("dashboardStudent", "Reset Password", Q_NULLPTR));
        pushButton_9->setText(QApplication::translate("dashboardStudent", "My Account Home", Q_NULLPTR));
        pushButton_10->setText(QApplication::translate("dashboardStudent", "Registrations", Q_NULLPTR));
        pushButton_11->setText(QApplication::translate("dashboardStudent", "Dashboard", Q_NULLPTR));
        pushButton_12->setText(QApplication::translate("dashboardStudent", "Course Search", Q_NULLPTR));
        home_label->setText(QApplication::translate("dashboardStudent", "My Account Home", Q_NULLPTR));
        myAccount_ComboBox->clear();
        myAccount_ComboBox->insertItems(0, QStringList()
         << QApplication::translate("dashboardStudent", "My Account Home", Q_NULLPTR)
         << QApplication::translate("dashboardStudent", "Registrations", Q_NULLPTR)
         << QApplication::translate("dashboardStudent", "Reset Password", Q_NULLPTR)
         << QApplication::translate("dashboardStudent", "My Program Sequence", Q_NULLPTR)
         << QApplication::translate("dashboardStudent", "Log Out", Q_NULLPTR)
        );
        groupBox->setTitle(QApplication::translate("dashboardStudent", "Current Program Enrolment:", Q_NULLPTR));
    } // retranslateUi
