...
"color: #333;"));
        ...
        createLectureButton->setObjectName(QString::fromUtf8("createLectureButton"));
        createLectureButton->setGeometry(QRect(370, 20, 111, 30));
        createLectureButton->setStyleSheet(QString::fromUtf8("background:#fbaf01;\n"
"color: #ffffff;\n"
"border:0;\n"
"height:30px;\n"
"border-radius:5px;"));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/icons White/Icons/White/Add User.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"border-radius:5px;"));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icons White/Icons/White/Passsword.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"border-radius:5px;"));
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/icons White/Icons/White/Double Arrow RIGHT.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"border-radius:5px;"));
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/icons White/Icons/White/Search.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"border-radius:5px;"));
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/icons White/Icons/White/Single Arrow LEFT.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"border-radius:5px;"));
        ...
        programSequenceSelected_label->setObjectName(QString::fromUtf8("programSequenceSelected_label"));
        ...
        programSequenceSelected_label->setStyleSheet(QString::fromUtf8("color:#666;"));
        facultySelected_label = new QLabel(academic);
        facultySelected_label->setObjectName(QString::fromUtf8("facultySelected_label"));
    ...
    void retranslateUi(QDialog *Register)
    {
        ...
        createLectureButton->setText(QCoreApplication::translate("Register", "  Create", nullptr));
        ...
        programComboBox->setItemText(1, QCoreApplication::translate("Register", "Associate", nullptr));
        programComboBox->setItemText(2, QCoreApplication::translate("Register", "Bachelor", nullptr));
        ...
        programSequenceSelected_label->setText(QCoreApplication::translate("Register", "Program Sequence SELECTED:", nullptr));
